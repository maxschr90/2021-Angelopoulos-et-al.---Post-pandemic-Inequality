...
function [] = simulateinitial_grp(ALPHA, Transitions, h_choice, k_choice, i_choice, c_choice, wages, r, aa, exostates, parms, grid_parms, worldstate, pctile, savename)
%% Set Initial Distribution
[initdist] = setinitialdistribution_grp(ALPHA, aa,  pctile, exostates, grid_parms);
    tic
